...
__get_inner_view() {
	...
	LR) echo "--output $INNER_PORT --mode 2560x1600  --pos 1920x320" ;;
...
__get_outer_view() {
	outport=$1
	case "$MODE" in
	LR) echo "--output $outport --mode 2560x1440 --rate 144 --scale 0.9999x0.9999 --pos 0x0 --primary" ;;
	TB) echo "--output $outport --mode 2560x1440 --rate 144 --pos 0x0 --primary" ;;
	HLR) echo "--output $outport --mode 2560x1440 --rate 144 --scale 0.9999x0.9999 --pos 0x0 --primary" ;;
	HTB) echo "--output $outport --mode 2560x1440 --rate 144 --scale 0.9999x0.9999 --pos 0x0 --primary" ;;
	esac
}
